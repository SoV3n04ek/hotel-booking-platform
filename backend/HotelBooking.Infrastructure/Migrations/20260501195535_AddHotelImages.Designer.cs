...
namespace HotelBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260501195535_AddHotelImages")]
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.HotelImage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_hotel_image");

                    b.HasIndex("HotelId")
                        .HasDatabaseName("ix_hotel_image_hotel_id");

                    b.ToTable("hotel_image", (string)null);
                });
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.RoomImage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_room_image");

                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_room_image_room_id");

                    b.ToTable("room_image", (string)null);
                });
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.HotelImage", b =>
                {
                    b.HasOne("HotelBooking.Domain.Entities.Hotel", "Hotel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hotel_image_hotels_hotel_id");
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.RoomImage", b =>
                {
                    b.HasOne("HotelBooking.Domain.Entities.Room", "Room")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_room_image_rooms_room_id");
