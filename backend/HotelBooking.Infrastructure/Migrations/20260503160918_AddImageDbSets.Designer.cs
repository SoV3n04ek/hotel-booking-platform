...
namespace HotelBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260503160918_AddImageDbSets")]
    partial class AddImageDbSets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.HotelImage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_hotel_images");

                    b.HasIndex("HotelId")
                        .HasDatabaseName("ix_hotel_images_hotel_id");
            ...
            modelBuilder.Entity("HotelBooking.Domain.Entities.HotelImage", b =>
                {
                    b.HasOne("HotelBooking.Domain.Entities.Hotel", "Hotel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hotel_images_hotels_hotel_id");
