...
public class BookingServiceTest
{
    ...
    public async Task CreateBooking_ShouldThrowException_WhenDatesAreInvalid()
    {
        ...
        var service = new BookingService(mockBookingRepo.Object, mockRoomRepo.Object, mockUow.Object);
        ...
        mockRoomRepo.Setup(repo => repo.IsRoomAvailableAsync(
            It.IsAny<int>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>()))
            .ReturnsAsync(true);

        mockRoomRepo.Setup(repo => repo.GetByIdAsync(It.IsAny<int>()))
